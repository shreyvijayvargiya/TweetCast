...
export const postTweetApi = (data) => {
  ...
  let headers = { 
    ...
    'Authorization': 'OAuth oauth_consumer_key="tBhkYzwVodzWg2GbO82KOPv40",oauth_token="2567443994-Fv9AkncVVZIWekAGlM5xv315hLJgvpN0sK1zCJn",oauth_signature_method="HMAC-SHA1",oauth_timestamp="1612072683",oauth_nonce="4pd5rDXXU0B",oauth_version="1.0",oauth_signature="3OjRW2EhQ8O1FTQuEb8ZgDuBG6E%3D"', 
